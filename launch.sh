...
# Inspired by https://github.com/mlcommons/inference/blob/master/language/llama3.1-405b/launch_docker.sh
...
# Available backends
AVAILABLE_BACKENDS=("pytorch" "vllm" "sglang" "trtllm")
...
show_usage() {
    ...
    echo ""
    echo "Required:"
    echo "  --backend BACKEND        Backend to use: pytorch, vllm, sglang, trtllm"
    echo ""
    echo "Options:"
    ...
    echo "  $0 --backend trtllm --local-user 0"
}
