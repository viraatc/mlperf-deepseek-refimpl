...
docker run $DOCKER_RUN_OPTS $DOCKER_RUN_ARGS \
    $GPU_OPTS \
    -v /home/scratch.zhihanj_sw:/home/scratch.zhihanj_sw \
    -v /home/scratch.viraatc_sw:/home/scratch.viraatc_sw \
    -v /home/scratch.viraatc_sw_1:/home/scratch.viraatc_sw_1 \
    -v /home/mlperf_inference_data:/home/mlperf_inference_data \
